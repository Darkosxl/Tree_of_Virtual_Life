import {Application, Graphics, Sprite, Assets, Text, Container, RenderLayer} from "pixi.js";
...
async function initApp() {
                ...
                complete: function(results) {
                    const nodeData = results.data.map(row => {
                        ...
                        return {
                            ...
                            unlocked: row.unlocked === true || row.unlocked === 'true' || row.unlocked === 1,
    ...
    app.canvas.addEventListener('wheel', (e) => {
        ...
        const newZoom = direction > 0 ? currentZoom * scaleFactor : currentZoom / scaleFactor;
