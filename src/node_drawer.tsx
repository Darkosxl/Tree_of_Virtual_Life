...
export const burntOrange: NodeTheme = {
  ...
  ringStyle: "solid",
  stops: [
    [0.00, "rgba(255,255,255,1.00)"],  // pinpoint highlight
    [0.22, "rgba(255,235,155,0.97)"],  // pale amber
    [0.45, "rgba(255,171, 60,0.94)"],  // bright orange
    [0.70, "rgba(234,138, 42,0.91)"],  // mid orange
    [0.88, "rgba(185, 95, 24,0.88)"],  // **dark basin**
    [1.00, "rgba(147, 66, 15,0.85)"],  // edge under ring
  ],
};
...
export const brightAqua: NodeTheme = {
  ...
  stops: [
    [0.00, "rgba(255,255,255,1.00)"],  // tiny hotspot
    [0.10, "rgba(180,255,255,0.95)"],  // pale halo
    [0.25, "rgba(  0,225,255,0.94)"],  // bright aqua
    [0.55, "rgba(  0,165,205,0.90)"],  // mid aqua
    [0.78, "rgba(  0,100,140,0.88)"],  // **darker basin**
    [1.00, "rgba(  0, 70, 95,0.82)"],  // edge (matches fake)
  ],
};
...
export const deepTeal: NodeTheme = {
  ...
  stops: [
    [0.00, "rgba(240,245,250,0.95)"],  // faint hotspot
    [0.15, "rgba( 40,150,180,0.92)"],  // teal
    [0.35, "rgba( 22,105,135,0.90)"],  // mid-teal
    [0.60, "rgba( 11, 66, 90,0.88)"],  // dark teal basin
    [0.85, "rgba(  6, 38, 52,0.86)"],  // deep navy
    [1.00, "rgba(  4, 26, 36,0.83)"],  // edge under ring
  ],
};
...
function gradTex(r: number, th: NodeTheme): Texture {
  ...
  const d = r * 2;
  const cv = Object.assign(document.createElement("canvas"), { width: d, height: d });
...
export function makeThemedNode(
  ...
  c.addChild(
    new Graphics()
      .circle(-radius * 0.20, -radius * 0.20, radius * 0.18)
